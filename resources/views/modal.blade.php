    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah yakin akan mengeluarkan barang ini?</h3>
                {{ $some }}
                <form method="post" action="{{env('APP_URL')}}/dashboard/bmns/{{ $some }}/hapus">
                @csrf
